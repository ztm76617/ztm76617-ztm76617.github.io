...
```{r wash_plot, echo=FALSE, warning=FALSE, cache=TRUE}
#--------------------------------------------------------------------------------------
# fedr ggplot
#--------------------------------------------------------------------------------------
map_dfr(c("SMU11000000500000003",
  ...
  mutate(date = ymd(date),
         series_id = case_when(series_id == "SMU11000000500000003" ~ "Avg. Hourly Earnings",
  ...
  labs(x = "Date",
       ...
       caption = "Data Source(s): Federal Reserve Economic Data (FRED)") +
  theme(text = element_text(face = 'bold'),
        panel.background = element_rect(colour = "black"),
...
```{r ineq_plot, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE, fig.width=8, fig.asp=0.8}
#--------------------------------------------------------------------------------
mega_combined_vars_df_SUBSET_added_vars %>%
  group_by(year) %>%
  filter(country_code_ISO3 %in% c("CAN", "USA", "GBR",
